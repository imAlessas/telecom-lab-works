...
ab work 5 uses the lab 3 code and implements a matched filter receiver in all of the three modulation techniques. This receiver uses the _covolution_ to identify the correct symbol in the disturbed signal.
